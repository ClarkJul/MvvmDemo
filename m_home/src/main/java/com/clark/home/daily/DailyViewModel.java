...
import com.clark.base.model.BasePagingModel;
import com.clark.base.model.IPagingModelListener;
 ...
 * @since 2020-02-14
 */
public class DailyViewModel extends MvmBaseViewModel<IDailyView, DailyModel> implements IPagingModelListener<ArrayList<BaseCustomViewModel>> {
    ...
    @Override
    public void onLoadFail(BasePagingModel model, String prompt, boolean isRefresh) {
        if (getPageView() != null) {
            if (isRefresh) {
