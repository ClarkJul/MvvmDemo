package com.clark.common.config;
...
{
    /** 基础库 */
    private static final String BaseInit = "com.clark.common.CommonModuleInit";
    
    /** main组件库 */
    private static final String MainInit = "com.clark.main.application.MainModuleInit";
